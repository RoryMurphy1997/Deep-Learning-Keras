...
def baseline_model():
    ...
    model.add(Flatten())
    # Fully connected hidden layer with 128 neurons is used
    model.add(Dense(128, activation='relu'))
    # Filly connected hidden layer with 50 neurons is used
